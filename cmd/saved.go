...
func fetchGithubSavedEmails(domain string) {
	...
	url := fmt.Sprintf("https://raw.githubusercontent.com/rix4uni/email-inventory/main/Emails/%s.txt", domain)
...
var savedCmd = &cobra.Command{
	Use:   "saved",
	Short: "Fetches emails for given domains using github.com/rix4uni/email-inventory/tree/main/Emails",
	Long: `This command fetches and displays emails for the specified domains from a remote text file.
In github.com/rix4uni/email-inventory/tree/main/Emails.
